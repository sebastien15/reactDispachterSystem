...
function LocationList() {
    return(
        <div>
            <header className="bg-blue-900 text-white p-1 text-center">Location List</header>
            <div className="mt-2 text-xs">
                ...
                <button className="border border-blue-500 hover:bg-blue-500 hover:text-white p-1">Show all locatin</button>
            </div>
            <div className="mt-2">
                <table className="w-full">
                    <tbody className="border border-blue-900">
                        <tr className="bg-blue-900 text-white  text-xs text-center">
                            <td className="border-r border-white">Location name</td>
                            <td className="border-r border-white">Location Type</td>
